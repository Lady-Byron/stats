...
var BaseStatsManager = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content(vnode) {
    ...
    }), m(_MoneyAndStoriesImages__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
var MoneyAndStoriesImages = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view(vnode) {
    return m("div", {
      ...
      placeholder: flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default().translator.trans('justoverclock-stats.admin.storiesImgInputName'),
      className: "FormControl",
      type: "text"
    }), m("button", {
      onclick: this.attrs.onSave,
